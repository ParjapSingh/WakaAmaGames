...
class WakaAmaApp(tk.Tk):
    ...
    def show_welcome(self):
        ...
        tk.Label(self, text="Enter the year you want to analyse (e.g. 2017):", font=("Arial", 12)).pack(pady=10)
        ...
        # Submit button
        tk.Button(self, text="Submit", font=("Arial", 12), command=self.handle_year_input).pack(pady=10)
    ...
    def analyze_finals(self):
        ...
        # Print the points for testing (will change it into gui printing in next sprint)
        print("Points awarded to each association:")
        for org, pts in self.points.items():
            print(f"{org}: {pts}")
        
        # Show results button (does nothing yet as it will be coded in next sprint)
        tk.Button(self, text="Show Results", font=("Arial", 12)).pack(pady=10)
